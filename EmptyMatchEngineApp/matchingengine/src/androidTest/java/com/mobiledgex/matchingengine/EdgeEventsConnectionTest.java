...
public class EdgeEventsConnectionTest {
    ...
    Location edmontonLoc, montrealLoc, automationFrankfurtCloudlet, automationHamburgCloudlet;
    ...
    public void locationGetTogglerSetup() {
        ...
        automationFrankfurtCloudlet = getTestLocation();
    ...
    public void testEdgeConnectionJustWaitForOne() {
        ...
        MatchingEngine me = null;
        String locationProvider = "testEdgeConnectionJustWaitForOne";
        try {
            me = new MatchingEngine(context);
            me.setMatchingEngineLocationAllowed(true);
            registerClient(me);
            ...
            latch.await(GRPC_TIMEOUT_MS*1999, TimeUnit.MILLISECONDS);
    ...
    public void LocationUtilEdgeEventsTest() {
        ...
        try {
            ...
            // Cannot use the older API if overriding.
            AppClient.FindCloudletRequest findCloudletRequest = me.createDefaultFindCloudletRequest(me.mContext, automationFrankfurtCloudlet)
                    .setCarrierName(findCloudletCarrierOverride)
                    .build();
            ...
            me.getEdgeEventsConnection().postLocationUpdate(automationHamburgCloudlet);
            er.setLatch(1);
            er.latch.await(GRPC_TIMEOUT_MS * 3, TimeUnit.MILLISECONDS);
            assertEquals("Wrong number of responses", 1, er.responses.size());

            me.getEdgeEventsConnection().postLocationUpdate(automationFrankfurtCloudlet);
            er.setLatch(1);
            er.latch.await(GRPC_TIMEOUT_MS * 3, TimeUnit.MILLISECONDS);
    ...
    public void LocationUtilEdgeEventsTestNoAutoMigration() {
        ...
        try {
            ...
            AppClient.FindCloudletRequest findCloudletRequest = me.createDefaultFindCloudletRequest(context, automationFrankfurtCloudlet)
                    .setCarrierName(findCloudletCarrierOverride)
                    .build();
